    ...
    s.append(grid(
        ...
        [["他の端末に圃場が出ない",
         ...
         ["送信が急に全部失敗するようになった",
          ...
          "削除済みの行は30日で片付けます。"],
         ["同じ圃場を1日に2回散布したのに、地図が緑のまま",
          "<b>既知の不具合です（v8.82時点で未修正）。</b>実績を入れた圃場を"
          "「＋ 「〇〇」の◯圃場をまとめて追加」でもう一度入れると、2回目の分が未実施でも"
          "進捗地図は緑（実施済）のままになります。"
          "<b>作業リストの「◯ / ◯ 済」「あと ◯ 圃場」は正しい数を出す</b>ので、"
          "1日に2回散布する日は地図の色ではなくこちらで残りを確認してください。"],
         ["圏外で地図が真っ白",
